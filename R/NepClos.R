...
#' @examples 
#' mapporco();lines(lat~long,NepClos,col=2,lwd=2)
#' @family mapas
#' @family Porcupine
#' @export
NepClos<-data.frame(long=c(-12.31666667,-12.5,-12.66,-12.93333333,-13.89716667,-14.4,-14.05,-13.41666667,-13.125,-12.91666667,-12.71666667,-12.61666667,-12.38333333,-12.31666667),
