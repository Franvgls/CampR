...
#' 
#' Salida de datos a csv para rellenar los informes de grupo de trabajo por estrato, filas con datos ab estratificada (Biomasa y N) y error estándar por sector. Da la abundancia y error estándar en cada sector (geográfico definido en el Camp)
...
#' @export
#' 
databEstr<-function(gr,esp,camp,dns="Cant",cor.time=T,Nas=F) {
