...
#' 
#' Salida de datos a csv para rellenar los informes de grupo de trabajo, filas con datos ab estratificada (Biomasa y N) y error estándar por subdivisión ICES función para el Demersales Norte (saca IXa, VIIIc Este y Oeste) 
...
#' @seealso databICESDiv {\link{databICESDiv.r}}
#' @export
databICES<-function(gr,esp,camp,dns="Cant",cor.time=T,Nas=F) {
  ...
  colnames(dumb7)<-c("IXaN_Avg","IXaN_SE","VIIIcW_Avg","VIIIcW_SE","VIIIcE_Avg","VIIIcE_SE","Tot_Avg","Tot_SE")
  dumb7
}
