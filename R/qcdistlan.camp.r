...
#' @export
qcdistlan.camp<-function(camp,dns="Cant",todos=FALSE,pc.error=2,plots=T) {
  ...
  else return(dumblan[abs(dumblan$error.dist)>pc.error | abs(dumblan$error.vel)>pc.error*3 | abs(dumblan$error.rumb)>pc.error*3,
