...
#'   NepFU31.camp("N21")
#' @export
NepFU31.camp<-function(camp=camp,dns="Cant",plot=TRUE,es=FALSE,ti=TRUE,ICESlab=FALSE,ceros=T,
  ...
  lans_FU31<-dplyr::filter(datlan.camp(camp,"Cant",redux=T,incl2=T,incl0 = F),c(long>c(-8) & long<c(-2) & lat >c(43) & lat<(44.5)))
