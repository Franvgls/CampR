...
Es muy importante utilizar <b>"Microsoft Access Dbase driver .dbf, .ndx"</b> y no "driver do Microsoft dBase .dbf" que no funciona bien.
...
- <B> ListCamps(dns="Xxxx",tablas=TRUE)</B>: en este caso ficheros de la campaña "Porcupine"

```{r echo=FALSE, message=TRUE, warning=FALSE, paged.print=TRUE, results='markup'}
CampR::CampsDNS.camp("Porc")
```
- <B> ListCamps(dns="Xxxx",tablas=TRUE)</B>: en este caso ficheros de la campaña "Demersales"
