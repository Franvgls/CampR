...
#' @export
ListFauna.groups<- function(camp,dns,excl.sect=NA,incl2=FALSE,cor.time=TRUE,kg=TRUE) {
  dumb<-ListFauna.camp(1,camp,dns,excl.sect=excl.sect,incl2=incl2,cor.time=cor.time)
    for (i in 2:5) {
